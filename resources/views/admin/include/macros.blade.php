...
<#macro aboutOneBlog>
    ...
    <div class="modal-dialog modal-lg" role="document" style="width: 70%;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel2">关于犯二青年博客 - 一个简洁美观、功能强大并且自适应的Java博客</h4>
            </div>
            <div class="modal-body notice-box">
                <div class="row">
                    <div class="col col-lg-4 col-sm-4 col-md-4 col-xs-4">
                        <fieldset>
                            <legend>添加微信</legend>
                            <a href="#" class="showImage" title="待定" rel="external nofollow" style="display: block;text-align: center">
<#--                                <img src="#" class="img-rounded" alt="待定" width="300">-->
                            </a>
                    ...
                    <div class="col col-lg-4 col-sm-4 col-md-4 col-xs-4">
                        <fieldset>
                            ...
                            <ul>
                                ...
                                <li><span><span><strong>实时通讯</strong>：管理员可向在线的用户发送实时消息（需用户授权 - 基于websocket实现）</span></span></li>
