                        ...
                        <section class="login_content">
                            <form action="/passport/signin" method="POST" id="login-form">
                                ...
                                <div class="separator">
                                    <div class="clearfix"></div>
                                    <div>
                                        Bootstrap Admin Template By <a href="https://findcat.cn">FindCat</a>
                                    </div>
                                </div>
                            </form>
                        </section>
...
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/jquery-confirm@3.3.2/dist/jquery-confirm.min.js">
</script>
        ...
        $.ajax({
            ...
            success: function (json) {
                ...
                if (json.status === 200) {
                    ...
                    $("#img-kaptcha").attr("src", '/getCaptcha?time=' + new Date().getTime());
                }
            }
        });
    });
    $("#img-kaptcha").click(function () {
        $(this).attr("src", '/getCaptcha?time=' + new Date().getTime());
    });
